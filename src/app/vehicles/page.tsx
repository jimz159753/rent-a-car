            ...
            data.map((vehicle: IVehicle) => (
              ...
              >
                    ...
                    <div>
                      ...
                      <div className="flex gap-5">
                        ...
                        <div className="logo">
                          <FaCarSide size={20} />
                          <p>
                            {vehicle.transmition === TransmitionEnum.AUTOMATIC
                              ? "A"
                              : "M"}
                          </p>
                        </div>
                ...
                <Button
                  onClick={() =>
                    router.push(
                      `/register?vehicle=${JSON.stringify(vehicle)}&startDate=${searchParams.startDate}&endDate=${searchParams.endDate}&agency=${agency}`,
                    )
                  }
                >
                  Reservar
