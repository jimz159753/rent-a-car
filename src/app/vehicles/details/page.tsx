      ...
      <div className="flex justify-between gap-20 max-desktop:flex-col max-desktop:gap-0 max-desktop:mb-11">
        <Card
          cover={
            <Image
              alt="vehicle"
              src={`${process.env.FILES_URL}${vehicle.image}`}
              preview={false}
        ...
        <div className="description">
          Un auto sedán standard automático de excelente rendimiento para
          compartir el viaje e ir a donde más te guste. Reserva un vehículo
          sedán standard automático, incluyendo el Chervrolet Onix o similar con
          Avis y llega a donde te propongas con su espacio para compartir y gran
          rendimiento de combustible. La marca y modelo de los vehículos están
          sujetos a disponibilidad y ubicación. Marcas y modelos similares que
          podrías recibir: MG MG5, VW Vento o similar.
        </div>
      </div>
